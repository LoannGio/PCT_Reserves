...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Premiere",sLast:"Dernière",sNext:"Suivante",sPrevious:"Précédente"},sEmptyTable:"Aucun sondage en cours.",sInfo:"Affiche de _START_ à _END_ parmi _TOTAL_ entrées",sInfoEmpty:"Il n'y a pas d'entrées à afficher.",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Afficher _MENU_ entrées par page",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Recherche:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Aucun enregistrements correspondants trouvés"},
